...
<html>
  <head>
    ...
    -->
    <link rel="stylesheet" type="text/css" href="<c:url value='/static/style/css.css'/>">
    <link rel="stylesheet" type="text/css" href="<c:url value='/static/style/user/pwd.css'/>">
    <script type="text/javascript" src="<c:url value='/static/jquery/jquery-1.5.1.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/static/js/user/pwd.js'/>"></script>
    ...
    <div class="div1">
        ...
        <table>
            ...
            <tr>
                <td align="right"></td>
                <td>
                  <img onclick="javascript:_change();" id="vCode" src="<c:url value='/VerifyCodeServlet'/>" border="1"/>
