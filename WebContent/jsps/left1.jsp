...
<div class="container">
    ...
    <div class="leftsidebar_box">
        <div class="line"></div>
        <dl class="system_log">
            <dt>我的资料<img src="/gcoads/static/images/left/select_xl01.png" ></dt>
            <dd><a href="<c:url value='/GraduateServlet?method=findGraduateByLoginname'/>" target="body">个人信息</a></dd>
            <dd><a href="<c:url value='/jsps/user/pwd.jsp'/>" target="body">修改密码</a></dd>
        </dl>
