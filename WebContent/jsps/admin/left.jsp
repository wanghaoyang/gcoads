...
<div class="container">
    <div class="leftsidebar_box">
        ...
        <dl class="custom">
            ...
            <dd><a href="<c:url value='/admin/GraduateManagementServlet?method=findStudent'/>" target="body">毕业生基本信息管理</a></dd>
            <dd><a href="<c:url value='/admin/GraduateManagementServlet?method=findGraduate'/>" target="body">毕业生毕业信息管理</a></dd>
            <dd><a href="<c:url value='/admin/GraduateManagementServlet?method=findEducationalLevel'/>" target="body">毕业生学历认证管理</a></dd>
            <dd><a href="<c:url value='/admin/GraduateManagementServlet?method=addStudent'/>" target="body">毕业生信息录入</a></dd>
        </dl>
    
        <dl class="channel">
            <dt>学历管理<img src="/gcoads/static/images/left/select_xl01.png"></dt>
            <dd><a href="<c:url value='/admin/EducationalLevelManagementServlet?method=findEducationalLevel'/>" target="body">学历信息管理</a></dd>
