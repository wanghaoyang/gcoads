...
public class VerifyDateFormat {
	 ...
	 * @return
	 */
	public static Map<String, String> VerifyStudentDateFormat(
			Map<String, String> map, Student stu) {
		...
		if (map != null && stu != null) {
			...
			} else if (stu.getStudentgender().equals("男")
					|| stu.getStudentgender().equals("女")) {
				map.put("studentgender", "性别非法!");
			}
