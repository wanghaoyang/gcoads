...
public class EducationalLevelManagementServlet extends BaseServlet {
	...
	public String findEducationalLevel(HttpServletRequest req, HttpServletResponse resp)
         ...
         * 4. 得到PageBean
         */
        pageEducationalLevel = educationalLevelService.findEducationalLevelByPager(pageEducationalLevel, educationalLevel);
        /*
	...
	public String addStudentByForm(HttpServletRequest req,
		...
		EducationalLevel formEducationalLevel = CommonUtils.toBean(req.getParameterMap(),EducationalLevel.class);
		Map<String, String> errorMap = null;

		try {
			errorMap = educationalLevelService.addGraduateInfoByExcel(formEducationalLevel);
		} catch (Exception e) {
