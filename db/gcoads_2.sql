...
INSERT INTO `t_educationallevel` VALUES (4,'博士'),(1,'大专'),(5,'无'),(2,'本科'),(3,'硕士');
...
CREATE TABLE `t_student` (
  ...
  `zhuanyefangxiang` varchar(45) NOT NULL,
  `peiyangfangshi` varchar(45) NOT NULL,
  `xuezhi` int(11) NOT NULL,
  `ruxueshijian` date NOT NULL,
  `biyeshijian` date NOT NULL,
  `isshifansheng` tinyint(1) NOT NULL,
...
-- Dump completed on 2017-04-11 16:52:14
